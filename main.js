...
function listImages(response) {
    ...
    $(entries).each(function(){
        console.log(this);
        instas.append($('<li><img width="400" src="' + this['media$group']['media$thumbnail'][0].url.replace(/\/s[0-9]+\//, '/s1920/') + '"></li>'));
    });
  ...
  $('.slideshow').tdslideshow({timeout: 7000});

}

$(function() {

var jsonpURL = "https://picasaweb.google.com/data/feed/api/user/107109598009663547203/albumid/5881034561901812705?alt=json&authkey=Gv1sRgCLrjoeKwxeaf6QE&callback=listImages";
